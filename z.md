...
#### Zeroing
Correcting the current stock level of a product line to zero, forcing an order to be generated by SBO.
> See also [Sales-based ordering system](s.html#sales-based-ordering-system-sbo).
